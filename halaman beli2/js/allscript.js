...
function activeTicket(target, inputValue, ticketPrice, total, ticketType) {
    // Formatter untuk mengubah nilai menjadi format Rupiah dengan simbol "Rp"
	...
	if(inputValue > 0) {
		...
		$('.ticket-amount').html(formatter.format(ticketPrice));
		$('.total-amount').html(formatter.format(total));
	} else {
